...
report_dir = "report_ConvWgan128_CelebA"
...
os.makedirs("report_ConvWgan128_CelebA/images", exist_ok=True)

# Path to save the models
save_path = 'saves_ConvWgan128/'
...
checkpoint_path = 'saves_ConvWgan128/checkpoint_epoch_315.pth'  
...
for epoch in range(start_epoch+1, opt.n_epochs):
    ...
    with torch.no_grad():
      ...
      plt.savefig(os.path.join("report_ConvWgan128_CelebA/images", f"epoch_{epoch+1}_generated_images.png"))
      plt.close()

    directoryL = "report_ConvWgan128_CelebA/losses"
    directoryS = "report_ConvWgan128_CelebA/scores"
    directoryA = "report_ConvWgan128_CelebA/accuracies"
    ...
    if (epoch+1) % 30 == 0 or (epoch+1) == 1:
        ...
        plt.legend()
        plt.savefig(os.path.join("report_ConvWgan128_CelebA/losses", f"losses_graph_epoch_{epoch+1}.png"))
        plt.close()
        ...
        plt.legend()
        plt.savefig(os.path.join("report_ConvWgan128_CelebA/accuracies", f"accuracy_graph_epoch_{epoch+1}.png"))
        plt.close()
        ...
        plt.legend()
        plt.savefig(os.path.join("report_ConvWgan128_CelebA/scores", f"scores_graph_epoch_{epoch + 1}.png"))
        plt.close()
