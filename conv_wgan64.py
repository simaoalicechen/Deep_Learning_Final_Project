...
os.makedirs("report_ConvWgan64_CelebA/images", exist_ok=True)
...
for epoch in range(start_epoch, opt.n_epochs):
    ...
    with torch.no_grad():
            ...
            plt.savefig(os.path.join("report_ConvWgan64_CelebA/images", f"epoch_{epoch+1}_generated_images.png"))
            plt.close()
    ...
    directoryL = "report_ConvWgan64_CelebA/losses"
    directoryS = "report_ConvWgan64_CelebA/scores"
    directoryA = "report_ConvWgan64_CelebA/accuracies"
    ...
    if (epoch+1) % 30 == 0 or (epoch+1) == 1:
        ...
        plt.legend()
        plt.savefig(os.path.join("report_ConvWgan64_CelebA/losses", f"losses_graph_epoch_{epoch+1}.png"))
        plt.close()
        ...
        plt.legend()
        plt.savefig(os.path.join("report_ConvWgan64_CelebA/accuracies", f"accuracy_graph_epoch_{epoch+1}.png"))
        plt.close()
        ...
        plt.legend()
        plt.savefig(os.path.join("report_ConvWgan64_CelebA/scores", f"scores_graph_epoch_{epoch + 1}.png"))
        plt.close()
